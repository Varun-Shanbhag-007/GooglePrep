...
public class CountTriplets {
    ...
    //n3 solution
    static int countTripletsn3(int n, int sum)
    {
        // Initialize result
        int ans = 0;
    ...
    static int countTripletsn2(int n, int sum)
    {
        // Sort input array
        Arrays.sort(arr);
    ...
    public static void main(String[] args) {
        int sum = 12;
        System.out.println("N3 solution");
        System.out.println(countTripletsn3(arr.length, sum));

        System.out.println("N2 solution");
        System.out.println(countTripletsn2(arr.length, sum));
    }
}
